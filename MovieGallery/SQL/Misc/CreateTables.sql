...
CREATE TABLE Movies (
	...
	MovieImage NVARCHAR(1000) DEFAULT ('image-not-found.jpg'),
	MovieBackgroundImage NVARCHAR(1000) DEFAULT ('image-not-found.jpg'),
...
CREATE TABLE HeroMovie (
	HeroMovieID INT IDENTITY (1,1) PRIMARY KEY,
	MovieID INT,
	FOREIGN KEY (MovieID) REFERENCES Movies(MovieID) ON DELETE CASCADE
);
